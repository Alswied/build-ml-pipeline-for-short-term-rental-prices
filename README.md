...
This project fulfills all requirements of the **Udacity – Build an ML Pipeline for Short-Term Rental Prices** project.

### ✅ Project Links (Required)

- **GitHub Repository:**  
  https://github.com/Alswied/build-ml-pipeline-for-short-term-rental-prices

- **Weights & Biases Project (Public):**  
  https://wandb.ai/alswied-cariad/nyc_airbnb

Both links are intentionally included here based on Udacity requirements.
